...
static const unsigned int tcp_timeouts[TCP_CONNTRACK_TIMEOUT_MAX] = {
	[TCP_CONNTRACK_SYN_SENT]	= 60 SECS,
	[TCP_CONNTRACK_SYN_RECV]	= 30 SECS,
	[TCP_CONNTRACK_ESTABLISHED]	= 1 DAYS,
	[TCP_CONNTRACK_FIN_WAIT]	= 60 SECS,
	[TCP_CONNTRACK_CLOSE_WAIT]	= 30 SECS,
	[TCP_CONNTRACK_LAST_ACK]	= 15 SECS,
	[TCP_CONNTRACK_TIME_WAIT]	= 60 SECS,
	[TCP_CONNTRACK_CLOSE]		= 10 SECS,
	[TCP_CONNTRACK_SYN_SENT2]	= 60 SECS,
/* RFC1122 says the R2 limit should be at least 100 seconds.
   Linux uses 15 packets as limit, which corresponds
   to ~13-30min depending on RTO. */
	[TCP_CONNTRACK_RETRANS]		= 2 MINS,
	[TCP_CONNTRACK_UNACK]		= 2 MINS,
};
